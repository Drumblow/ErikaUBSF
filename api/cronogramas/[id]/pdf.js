...
async function generateFullHtml(cronograma, tableBody) {
    ...
    const leftLogoPath = path.join(process.cwd(), 'CRONOGRAMA MES JUNHO', 'images', 'image3.png');
    const rightLogoPath = path.join(process.cwd(), 'CRONOGRAMA MES JUNHO', 'images', 'image2.jpg');
    const headerTitleImagePath = path.join(process.cwd(), 'CRONOGRAMA MES JUNHO', 'images', 'image1.png');
